...
import (
	...
	nativesv1alpha1 "github.com/easyteam-fr/side-effects/blog/bot-operator/pkg/apis/natives/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &nativesv1alpha1.Bot{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func (r *ReconcileBot) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set Bot instance as the owner and controller
...
func newPodForCR(cr *nativesv1alpha1.Bot) *corev1.Pod {
